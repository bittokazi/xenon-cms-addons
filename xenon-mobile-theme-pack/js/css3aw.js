$(function(){
	...
	//social icon hover
	$("div#css3aw-social-menu-wrapper > span.icon-share").on("mouseenter", function(){
		$(this).addClass("hover");
		$("ul#css3aw-social-menu").addClass("hover");
	});
	$("div#css3aw-social-menu-wrapper > span.icon-share").on("click", function(){
	...
	$("ul#css3-social-menu").on("mouseleave", function(){
		$("div#css3aw-social-menu-wrapper > span.icon-share").removeClass("clicked");
		$("div#css3aw-social-menu-wrapper > span.icon-share").removeClass("hover");
		$("ul#css3aw-social-menu").removeClass("hover");
