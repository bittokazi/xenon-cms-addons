<?php
function frndzk_l_b_g() {
if(is_page() || is_post()) {
return'<script type="text/javascript" src="'.home_url().'/xenon-addons/frndzk-photo-lightbox-gallery/js/prototype.js"></script>
<script type="text/javascript" src="'.home_url().'/xenon-addons/frndzk-photo-lightbox-gallery/js/scriptaculous.js?load=effects"></script>
<link rel="stylesheet" href="'.home_url().'/xenon-addons/frndzk-photo-lightbox-gallery/css/lightbox.css" />
...
//	Configuration
//
var fileLoadingImage = \"".home_url()."/xenon-addons/frndzk-photo-lightbox-gallery/images/loading.gif\";		
var fileBottomNavCloseImage = \"".home_url()."/xenon-addons/frndzk-photo-lightbox-gallery/images/closelabel.gif\";
...
xenon_core("xenon_header", "frndzk_l_b_g");
function flbgf($content) {
return str_replace('><img', ' rel=lightbox[roadtrip]><img ',  $content);
}
xenon_core('xenon_content_filter', 'flbgf');
?>